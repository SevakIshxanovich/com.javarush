...
Integer.MAX_VALUE       Максимальное значение типа int= +2 147 483 647
Integer.MIN_VALUE       Минимальное значение типа int= -2 147 483 648
---------------------------------------------------------------------------
...
Integer Integer.parseInt(String)        Возвращает число, полученное из строки
         ...
         -----------------------------------------------------------------------------------
         int i =Integer.parseUnsignedInt("4000000");
         ------------------------------------------------------------------------------------
